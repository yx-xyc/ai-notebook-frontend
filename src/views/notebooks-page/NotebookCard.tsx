...
interface NotebookSimpleCardProps {
    userId: string;
    notebookId: string;
    title: string;
    category: string;
...
const NotebookSimpleCard = ({ userId, notebookId, title, category, createdAt, updatedAt }: NotebookSimpleCardProps) => {
                ...
                <Grid item xs={12} alignItems="center">
                    <Grid container spacing={gridSpacing}>
                        <Grid item xs zeroMinWidth>
                            <Link to={`/user/${userId}/notebook/${notebookId}`}>
...
export default NotebookSimpleCard;
